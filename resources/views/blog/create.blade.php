...
<head>
    ...
    <title>Tambah Data Blog - Geofanno</title>
                    ...
                    <div class="card-body">
                        <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('genre') is-invalid @enderror" name="genre" value="{{ old('genre') }}" placeholder="Masukkan Genre Blog">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('author') is-invalid @enderror" name="author" value="{{ old('author') }}" placeholder="Masukkan Nama Penulis">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('publisher') is-invalid @enderror" name="publisher" value="{{ old('publisher') }}" placeholder="Masukkan Nama Penerbit">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('publisher_year') is-invalid @enderror" name="publisher_year" value="{{ old('publisher_year') }}">
